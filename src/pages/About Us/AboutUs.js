        ...
        <div className="col">
          <div className="right-container border-8  border-blue-400 text-md font-sans my-10 pt-[30px] pb-[30px]">
            ...
            <p className="font-medium  p-6">
              ...
              over the technology sector. DTEC has partnerships with Cisco,
              COMMSCOPE, NEC, Palo Alto Networks, Dell EMC, HP, Blue Coat,
              NetApp, Veritas, Schneider Electric, APC, Triplite, Axis,
              Honeywell, Pelco, Aerocont, HikVision, ISO NAS, OZAK many others.
              As DTEC is Telecom Service Partner and as DTEC is a registered and
              approved contractor for Telecom companies that can deliver many
              project types, then DTEC has many divisions out of which the
              Infrastructure and solutions division has the business activities
              that include supply, Installation, support and services for
